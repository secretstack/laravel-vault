...
> **Superseded (version targets only):** [ADR-0012](0012-extend-laravel-support-12-13-php-83.md) extends support to Laravel 12/13 and raises the PHP floor to 8.3. The Lumen exclusion and all other rationale in this ADR remain in force.
